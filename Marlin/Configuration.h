...
#define STRING_CONFIG_H_AUTHOR "(strachank, SapphireTFT35)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 21.93
  #define DEFAULT_bedKi  4.28
  #define DEFAULT_bedKd 75.02
 ...
 */
//@ Sapphire Pro setup with adjusted step sticks
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
//@ settings from mks 1.0.3 stock firmware, and changed step sticks
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 1660 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -58, -2.2 }
